                            ...
                            <div className="service-single-content">
                                <div className="service-feature-image">
                                    <figure className="image-anime reveal">
                                        <img
                                            src={getAssetPath("/assets/images/product-images/inner-page-img/pre-workout-inner-page.webp")}
                                            alt="pre-workout"
                                        />
                                    </figure>
                                </div>
                                ...
                                <div className="section-title m-4 mx-0 ">
                                    ...
                                    <div className="about-list-box mt-4">
                                        <div className="about-list wow fadeInUp" data-wow-delay="0.4s">
                                            <ul>
                                                ...
                                                <li>Packaging Size - <span>250gm</span></li>
                                    ...
                                    <div className="hero-content-body wow fadeInUp" data-wow-delay="0.4s">
                                        <div className="hero-btn">
                                            <button onClick={() => {
                                                if (isUserLoggedIn()) {
                                                    window.location.href = '/booking-page?product=pre-workout';
                                                } else {
                        ...
                        <div className="col-lg-5">
                            <div className="service-sidebar">
                                <div className="service-catagery-list wow fadeInUp">
                                    ...
                                    <ul>
                                        <li>L-Citrulline <span>2.26 g</span></li>
                                        <li>YourBrand L-Arginine <span>0.45 g</span></li>
                                        <li>L-Taurine <span>0.36 g</span></li>
                                        <li>B-Alanine <span>0.36 g</span></li>
                                        <li>Caffeine Anhydrous <span>0.18 g</span></li>
                                        <li>Green Tea Extract <span>0.10 g</span></li>
                                        <li>Green Coffee Extract <span>0.10 g</span></li>
                                    </ul>
                                </div>
